...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.componentDidMount = function () {
	        ...
	        axios.get('http://fcctop100.herokuapp.com/api/fccusers/top/recent')
	            ...
	            var recentCampers = response.data;
	            recentCampers.forEach(function (recentCamper) {
	                _this.state.topRecentCampers.push(recentCamper);
	            });
	            _this.setState({ topRecentCampers: _this.state.topRecentCampers });
	        });
	        // Get top alltime campers
	        axios.get('http://fcctop100.herokuapp.com/api/fccusers/top/alltime')
	            .then(function (response) {
	            var alltimeCampers = response.data;
	            alltimeCampers.forEach(function (alltimeCamper) {
	                _this.state.topAlltimeCampers.push(alltimeCamper);
	            });
	            _this.setState({ topAlltimeCampers: _this.state.topAlltimeCampers });
	        });
	    };
	    App.prototype.changeSort = function (sortby) {
	        if (sortby == 'recent')
	            this.setState({ sorting: { recent: true, pointsRecent: this.state.sorting.pointsRecent } });
	        else
	            this.setState({ sorting: { recent: false, pointsRecent: this.state.sorting.pointsRecent } });
	    };
	    App.prototype.sortCampers = function (sortBy) {
	        if (sortBy == 'recent')
	            this.setState({ sorting: { recent: this.state.sorting.recent, pointsRecent: true } });
	        else
	            this.setState({ sorting: { recent: this.state.sorting.recent, pointsRecent: false } });
	    };
	    App.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {"id": "page-wrapper"}, React.createElement("div", {"id": "header"}, React.createElement("a", {"href": "http://www.freecodecamp.com/", "id": "logo-link"}, React.createElement("img", {"src": "https://s3.amazonaws.com/freecodecamp/freecodecamp_logo.svg", "id": "fcc-logo"})), React.createElement("div", {"id": "foot"}, React.createElement("a", {"id": "gh-link", "href": "https://github.com/Daynil/fcc-leaderboard"}, React.createElement("i", {"className": "fa fa-github-square fa-lg"})), "Created by ", React.createElement("a", {"href": "https://github.com/Daynil/"}, "Daynil"), " for ", React.createElement("a", {"href": "http://www.freecodecamp.com/"}, "FCC"))), React.createElement("div", {"className": "row", "id": "row-title"}, React.createElement("span", {"id": "leaderboard-title"}, "Leaderboard"), React.createElement("span", {"id": "sorting"}, React.createElement("span", {"className": this.state.sorting.recent ? 'selected' : 'unselected', "id": "recent", "onClick": function () { return _this.changeSort('recent'); }}, "Recent"), React.createElement("span", {"className": !this.state.sorting.recent ? 'selected' : 'unselected', "id": "alltime", "onClick": function () { return _this.changeSort('alltime'); }}, "All time"))), React.createElement(Leaderboard, {"topRecentCampers": this.state.topRecentCampers, "topAlltimeCampers": this.state.topAlltimeCampers, "sorting": this.state.sorting, "sortCampers": function (sortBy) { return _this.sortCampers(sortBy); }})));
	    };
	    return App;
	})(React.Component);
	var Leaderboard = (function (_super) {
	    ...
	    Leaderboard.prototype.displayCampers = function () {
	        var campersToDisplay = this.props.sorting.recent ? this.props.topRecentCampers : this.props.topAlltimeCampers;
	        var sortedCampersToDisplay;
	        if (this.props.sorting.pointsRecent)
	            sortedCampersToDisplay = campersToDisplay.sort(this.sortCampersRecent);
	        else
	            sortedCampersToDisplay = campersToDisplay.sort(this.sortCampersAlltime);
	        var campers = sortedCampersToDisplay.map(function (camper, index) {
	            var stripe = index % 2 > 0 ? "pure-table-odd" : "";
	            var userLink = "http://www.freecodecamp.com/" + camper.username;
	            return (React.createElement("tr", {"key": index, "className": stripe}, React.createElement("td", null, index + 1), React.createElement("td", null, React.createElement("img", {"src": camper.img, "className": "camper-img"}), React.createElement("a", {"href": userLink, "className": "username"}, camper.username)), React.createElement("td", null, camper.recent), React.createElement("td", null, camper.alltime)));
	        });
	        return React.createElement("tbody", null, campers);
	    };
	    Leaderboard.prototype.sortCampersRecent = function (a, b) {
	    ...
	    Leaderboard.prototype.sortCampersAlltime = function (a, b) {
	    ...
	    Leaderboard.prototype.sortCampers = function (sortBy) {
	        this.props.sortCampers(sortBy);
	    };
	    Leaderboard.prototype.getDescIcon = function (column) {
	        if (column == 'recent') {
	            if (this.props.sorting.pointsRecent)
	                return React.createElement("i", {"className": "fa fa-sort-desc"});
	        }
	        else {
	            if (!this.props.sorting.pointsRecent)
	                return React.createElement("i", {"className": "fa fa-sort-desc"});
	    ...
	    Leaderboard.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("table", {"id": "table-wrapper", "className": "pure-table"}, React.createElement("thead", null, React.createElement("tr", null, React.createElement("td", null, "#"), React.createElement("td", null, "Camper"), React.createElement("td", {"className": 'sorting-col', "onClick": function () { return _this.sortCampers('recent'); }}, "Points in last 30 days ", this.getDescIcon('recent')), React.createElement("td", {"className": 'sorting-col', "onClick": function () { return _this.sortCampers('alltime'); }}, "All time points ", this.getDescIcon('alltime')))), this.displayCampers()));
	    };
	    return Leaderboard;
	})(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#page-wrapper {\n  height: 100vh; }\n  #page-wrapper #header {\n    background-color: #006600;\n    display: flex;\n    justify-content: center;\n    min-width: 376px;\n    width: 100%;\n    flex-wrap: wrap; }\n    #page-wrapper #header #logo-link {\n      flex: 1;\n      margin-left: 50px; }\n    #page-wrapper #header #fcc-logo {\n      padding-top: 6px;\n      display: inline-block;\n      width: 269px;\n      height: 40px; }\n  #page-wrapper #row-title {\n    background-color: #006600;\n    text-align: center;\n    color: aliceblue;\n    font: normal 30px 'Open Sans';\n    display: flex;\n    justify-content: center;\n    flex-wrap: wrap;\n    position: relative;\n    top: 50px;\n    min-width: 376px;\n    width: 60%;\n    margin: 0 auto;\n    border-top-left-radius: 10px;\n    border-top-right-radius: 10px; }\n    #page-wrapper #row-title #leaderboard-title {\n      flex: 1;\n      text-align: center; }\n    #page-wrapper #row-title #sorting {\n      font-size: 15px;\n      padding: 10px;\n      margin-left: auto; }\n    #page-wrapper #row-title #recent {\n      position: relative;\n      right: 12px; }\n    #page-wrapper #row-title .selected {\n      text-decoration: underline;\n      cursor: pointer; }\n    #page-wrapper #row-title .unselected {\n      cursor: pointer; }\n  #page-wrapper #table-wrapper {\n    margin: 0 auto;\n    position: relative;\n    top: 50px;\n    width: 60%;\n    margin-bottom: 60px;\n    overflow-x: hidden;\n    border-left: 1px solid #006600;\n    border-right: 1px solid #006600;\n    border-bottom: 1px solid #006600;\n    padding: 10px 20px 15px 20px;\n    font: normal 20px 'Lato'; }\n    #page-wrapper #table-wrapper .sorting-col {\n      cursor: pointer; }\n    #page-wrapper #table-wrapper thead td {\n      font-weight: bold;\n      padding: 5px; }\n    #page-wrapper #table-wrapper i {\n      position: relative;\n      bottom: 3px;\n      left: 2px; }\n    #page-wrapper #table-wrapper tbody {\n      overflow: auto; }\n      #page-wrapper #table-wrapper tbody .stripe-custom {\n        background-color: #009900; }\n      #page-wrapper #table-wrapper tbody .camper-img {\n        width: 50px; }\n      #page-wrapper #table-wrapper tbody .username {\n        position: relative;\n        bottom: 16px;\n        left: 4px;\n        color: #006600;\n        cursor: pointer;\n        text-decoration: none;\n        transition: 0.2s; }\n        #page-wrapper #table-wrapper tbody .username:hover {\n          color: #009900;\n          text-decoration: underline; }\n      #page-wrapper #table-wrapper tbody td {\n        padding: 5px; }\n\n#foot {\n  font-family: 'Lato';\n  font-size: 18px;\n  color: aliceblue;\n  padding: 12px; }\n\n#foot i, #foot a {\n  color: springgreen;\n  transition: 0.3s;\n  text-decoration: none; }\n\n#foot a:hover, #gh-link:hover i {\n  color: aliceblue;\n  text-decoration: none; }\n\n#foot i {\n  position: relative;\n  right: 5px;\n  bottom: 1px; }\n", ""]);
